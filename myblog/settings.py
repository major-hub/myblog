...
SECRET_KEY = '=9ily^f9g2f=ibei6m-&i6sfxhq_h6r(u(5cre9g4ecj3_!u1+'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ['major-blog.herokuapp.com', '127.0.0.1', 'localhost']
...
CACHES = {
    'default': {
        ...
        'LOCATION': BASE_DIR / 'dj_caches',
    }
}


INTERNAL_IPS = ['127.0.0.1', 'major-blog.herokuapp.com']
